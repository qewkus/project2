...
# Модуль transaction processor
В нём мы возвращали список транзакций, описания которых содержат заданную строку
и возвращали словарь с количеством операций в каждой категории.

# Тест transaction processor

Всё протестировано успешно!
## Установка
